...
const Mission = () => {
  return (
    <div className='h-auto w-screen  bg-stone-100 pb-10 md:pb-20 pt-10 sm:pt-32 md:pt-32'>
      <div className='flex flex-col sm:flex-col xl:flex-row 2xl:flex-row md:flex-col items-center h-auto bg-white mx-4 sm:p-10 p-10 lg:p-10 md:p-0 md:ml-16 lg:ml-20 rounded-3xl xl:ml-32'>
        ...
        <div className='flex flex-col mt-16 md:mt-20 md:ml-12'>
