        ...
        <div className='flex flex-col  md:mb-0 md:w-screen h-auto bg-stone-100'>
          <div className='flex flex-col mt-10 md:mt-32'>
            <div className='flex flex-col md:ml-32 ml-10 gap-5'>
              ...
              <h1 className='text-7xl w-1/2'>Primary </h1>
            </div>
            <div className=' h-auto w-screen bg-stone-100 md:pb-10 pt-20 md:pt-12'>
              <div className='flex flex-col md:flex-row   md:h-full bg-white  md:mr-60 '>
                <div className='flex flex-col md:mt-20 ml-32'>
                ...
                <img src={Primary} alt="chs education center image" className='md:ml-20  md:h-3/4 p-10 md:w-1/2 -mt-44 ' />
              </div>
            </div>
            <div className=' h-auto w-screen flex justify-center items-center bg-stone-100 md:pb-10 pt-20 md:p-12'>
              <div className='flex flex-col md:flex-row w-3/4  md:h-96 bg-white'>
                <div className='flex flex-col m-20'>
                  <div className='flex justify-center items-center'>
                    <h1 className='text-3xl font-bold'><span className='border-b-4 border-green-500'>
                    Main</span> subjects</h1>
                    <div className=' ml-10 w-1/2 h-0 border-2 border-gray-200'></div>
                  </div>
                  <p className='text-lg text-justify mt-8'>The core subjects in Primary school are English, Mathematics, Science, and ICT. Other subjects include History, Geography, Music, Art and Design, Physical Education, and Spanish.</p>
                </div>
              </div>
            </div>
            <div className='w-screen  flex pb-10 flex-col h-auto md:p-12  justify-center items-center'>
              <div className='flex bg-white flex-col md:flex-row col-span-2 md:row-span-2 w-3/4'>
                <div className='flex flex-col gap-4 w-1/2  p-10'>
                  <h1 className='md:text-4xl font-semibold  '>Admission criteria & process</h1>
